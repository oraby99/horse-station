        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index-2.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="logo-sm" height="50">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="logo-dark" height="70">
                    </span>
                </a>
                ...
                <a href="index-2.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="logo-light" height="70">
                    </span>
                </a>
            </div>
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div data-simplebar style="max-height: 230px;" id="notification-list">
                      ...
                      {{-- <a href="{{route('admin.advertisment.index')}}" class="text-reset notification-item">
                        <div class="d-flex">
                            <img src="{{ asset('uploads/users/'.$item->image) }}"
                                class="me-3 rounded-circle avatar-xs" alt="user-pic">
                            <div class="flex-1">
                                <h6 class="mb-1">{{$item->user->name}}</h6>
                                <div class="font-size-12 text-muted">
                                    <p class="mb-1">Has Make New Advertisment</p>
                                    <p class="mb-0"><i class="mdi mdi-clock-outline"></i>{{$item->created_at->format('H:i:m')}}</p>
                                </div>
                            </div>
                        </div>
                    </a>        --}}
