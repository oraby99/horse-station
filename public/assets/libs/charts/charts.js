!(function (t, e) {
    ...
    function j(t, e, i, s) {
        var a;
        H(t) &&
            ((a = e[t]), (i = i[t]), A(a) && A(i) ? Y(a, i, s) : (e[t] = W(i)));
    }
    function Y(i, t, s) {
        var a,
            e = O(t) ? t : [t],
        ...
        if (t._sorted) {
            ...
            d &&
                (a = C(
                    Math.min(
                        f(r, o.axis, h).lo,
                        i ? s : f(e, l, o.getPixelForValue(h)).lo
                    ),
                    0,
                    s - 1
                )),
    ...
    const ue = {
        ...
        numeric(t, e, i) {
            ...
            var o = r(Math.abs(n)),
                o = isNaN(o)
                    ? 1
                    : Math.max(Math.min(-1 * Math.floor(o), 20), 0),
                o = {
                    notation: a,
    ...
    const ci = (t) => 0 === t || 1 === t,
        ...
        ui = (t, e, i) =>
            Math.pow(2, -10 * t) * Math.sin(((t - e) * _) / i) + 1,
        gi = {
            linear: (t) => t,
            easeInQuad: (t) => t * t,
            easeOutQuad: (t) => -t * (t - 2),
        ...
        return Ii(
            ...
            !0 === n
                ...
                : (function (t, e, i, s) {
                      ...
                      return (
                          null !== r &&
                              n.push({ start: e % a, end: r % a, loop: s }),
                          n
                      );
                  })(
                      i,
            ...
            for (const r of t) {
                ...
                for (i = o + 1; i <= r.end; i++) {
                    ...
                    (function (t, e) {
                        ...
                        function i(t, e) {
                            return ne(e)
                                ? (s.includes(e) || s.push(e), s.indexOf(e))
                                : e;
                        }
                        const s = [];
        ...
        modes: {
            index(t, e, i, s) {
                const a = Se(e, t),
                    ...
                    r = i.intersect ? Bi(t, a, n, s, o) : Ni(t, a, n, !1, s, o),
                    l = [];
                return r.length
            ...
            dataset(t, e, i, s) {
                ...
                let o = i.intersect ? Bi(t, e, a, s, n) : Ni(t, e, a, !1, s, n);
                if (0 < o.length) {
            ...
            nearest(t, e, i, s) {
                var e = Se(e, t),
                    a = i.axis || "xy",
                    n = i.includeInvisible || !1;
                return Ni(t, e, a, i.intersect, s, n);
            },
            x: (t, e, i, s) => Wi(t, Se(e, t), "x", i.intersect, s),
            y: (t, e, i, s) => Wi(t, Se(e, t), "y", i.intersect, s),
        },
    };
            ...
            if (A(s)) {
                ...
                Object.getOwnPropertyNames(s).forEach((e) => {
                    ...
                    if (A(t)) {
                        ...
                        ((O(t.properties) && t.properties) || [e]).forEach(
                            (t) => {
    ...
    class Os {
        ...
        getMinMax(e, t) {
            const i = this._cachedMeta,
                ...
                r =
                    ...
                    t &&
                        !i.hidden &&
                        i._stacked && { keys: _s(d, !0), values: null }),
                l = {
        ...
        draw() {
            ...
            let h;
            for (
                i.dataset && i.dataset.draw(t, a, o, r), h = o;
                h < o + r;
                ++h
            ) {
                const e = s[h];
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return (
                g.$shared &&
                    ((g.$shared = r), (a[n] = Object.freeze(Cs(g, r)))),
                g
            );
        }
    ...
    class zs extends e {
                ...
                n.display &&
                    ...
                    ((this.ticks = (function (t, s) {
                        ...
                        if (0 < o) {
                            let t, e;
                            const i =
                                1 < o ? Math.round((l - r) / (o - 1)) : null;
                            for (
                                As(s, h, m, P(i) ? 0 : r - i, r),
                                    t = 0,
                                    e = o - 1;
                                t < e;
                                t++
        ...
        _isVisible() {
            ...
            return "auto" !== t
                ? !!t
                : 0 < this.getMatchingVisibleMetas().length;
        }
    ...
    class Fs {
        ...
        unregister(t) {
            ...
            i in e && delete e[i],
                s &&
                    i in R[s] &&
                    (delete R[s][i], this.override && delete fe[i]);
        }
    }
    var b = new (class {
        constructor() {
    ...
    class Vs {
        ...
        _notifyStateChanges(t) {
            var e = this._oldCache || [],
                ...
                s = (t, i) =>
                    t.filter(
                        (e) => !i.some((t) => e.plugin.id === t.plugin.id)
                    );
            ...
            (e.scales = (function (o, e) {
                ...
                return (
                    Object.keys(r).forEach((t) => {
                        ...
                        if (e._proxy)
                            return console.warn(
                                "Ignoring resolver passed as options for scale: " +
                                    t
                            );
                        const i = Ws(
                                t,
    ...
    class i {
            ...
            for (
                ...
                if (
                    ...
                    const i = b.getController(n),
                        { datasetElementType: a, dataElementType: o } =
                            R.datasets[n];
                    Object.assign(i, {
            ...
            !1 !== this.notifyPlugins("beforeDatasetDraw", n) &&
                (s &&
                    Ve(t, {
                        ...
                        bottom:
                            !1 === e.bottom ? this.height : a.bottom + e.bottom,
                    }),
                i.controller.draw(),
                s && Be(t),
                (n.cancelable = !1),
        ...
        _handleEvent(t, e, i) {
            ...
            return (
                (c || e) &&
                    ((this._active = o), this._updateHoverStyles(o, s, e)),
                (this._lastEvent = l),
                c
            );
        }
    ...
    class fa extends Os {
        ...
        update(t) {
                    ...
                    if (e < _) {
                        const r = t,
                            ...
                            g = (t, e, i) =>
                                pt(t, r, l, !0)
                                    ? 1
                                    : Math.max(e, e * s, i, i * s),
                            f = (t, e, i) =>
                                pt(t, r, l, !0)
                                    ? -1
                                    : Math.min(e, e * s, i, i * s),
                            p = g(0, h, d),
                            m = g(D, c, u),
                            b = f(S, h, d),
                            x = f(S + D, c, u);
            ...
            (this.offsetX = g * x),
                ...
                (this.outerRadius =
                    x - v * this._getRingWeightOffset(this.index)),
        ...
        updateElements(t, e, i, s) {
            const a = "reset" === s,
                ...
                { sharedOptions: g, includeOptions: f } =
    ...
    var ma = Object.freeze({
                        ...
                        (function (t) {
                            ...
                            var l = () => {
                                32767 !== n &&
                                    -32768 !== n &&
                                    (G(o) &&
                                        (r = Math.min(r, Math.abs(n - o) || r)),
                                    (o = n));
                            };
                            for (s = 0, a = i.length; s < a; ++s)
                                (n = e.getPixelForValue(i[s])), l();
                            for (
                                o = void 0, s = 0, a = e.ticks.length;
                                s < a;
                                ++s
                            )
        ...
        BubbleController: class extends Os {
            ...
            getMaxOverflow() {
                ...
                for (let t = e.length - 1; 0 <= t; --t)
                    i = Math.max(
                        i,
                        e[t].size(this.resolveDataElementOptions(t)) / 2
                    );
                return 0 < i && i;
            }
            getLabelAndValue(t) {
            ...
            updateElements(e, i, s, a) {
                const n = "reset" === a,
                    ...
                    { sharedOptions: l, includeOptions: h } =
                        this._getSharedOptions(i, a),
                    c = o.axis,
                    d = r.axis;
                for (let t = i; t < i + s; t++) {
        ...
        PieController: class extends fa {
            static id = "pie";
            static defaults = {
                cutout: 0,
                rotation: 0,
            ...
            getMaxOverflow() {
                ...
                if (!this.options.showLine) {
                    ...
                    for (let t = i.length - 1; 0 <= t; --t)
                        e = Math.max(
                            e,
                            i[t].size(this.resolveDataElementOptions(t)) / 2
                        );
                    return 0 < e && e;
                }
                var e = t.dataset,
    ...
    function Ma(t, e, i, s) {
        const { points: a, options: n } = e,
            { count: o, start: r, loop: l, ilen: h } = ya(a, i, s),
            c = n.stepped
                ? Ne
    ...
    function wa(t, e, i, s) {
        const a = e.points,
            { count: n, start: o, ilen: r } = ya(a, i, s),
    ...
    const Sa = "function" == typeof Path2D;
    class Pa extends e {
        static id = "line";
        static defaults = {
            borderCapStyle: "butt",
    ...
    function Aa(t, e, i, s) {
        var a = null === e,
            ...
            t = t && !(a && n) && Ca(t, s);
        return (
            t && (a || c(e, t.left, t.right)) && (n || c(i, t.top, t.bottom))
        );
    }
    function Ta(t, e) {
    ...
    var Ea = Object.freeze({
        ...
        BarElement: class extends e {
            ...
            draw(t) {
                const {
                    ...
                    { inner: a, outer: n } =
                        ...
                        (d = Mi(d)),
                        (p = {
                            t: Oa(h.top, d.top, 0, p),
                            r: Oa(h.right, d.right, 0, c),
                            b: Oa(h.bottom, d.bottom, 0, p),
                            l: Oa(h.left, d.left, 0, c),
                        }),
                        (h = g / 2),
                        (d = f / 2),
                        (r = (c = r).getProps([
                        ...
                        }),
                        {
                            ...
                            inner: {
                                ...
                                radius: {
                                    topLeft: Math.max(
                                        0,
                                        r.topLeft - Math.max(p.t, p.l)
                                    ),
                                    topRight: Math.max(
                                        0,
                                        r.topRight - Math.max(p.t, p.r)
                                    ),
                                    bottomLeft: Math.max(
                                        0,
                                        r.bottomLeft - Math.max(p.b, p.l)
                                    ),
            ...
            inRange(t, e, i) {
                return Aa(this, t, e, i);
            }
            inXRange(t, e) {
                return Aa(this, t, null, e);
            }
            inYRange(t, e) {
                return Aa(this, null, t, e);
            }
            getCenterPoint(t) {
                var {
                    x: t,
    ...
    function Ia(t, e, { horizontal: i, minRotation: s }) {
            ...
            const s = (function (t, e) {
                ...
                for (
                    ...
                    (d && y !== n
                        ? (i.push({ value: n }),
                          y < n && S++,
                          at(Math.round((y + S * k) * _) / _, n, Ia(n, v, t)) &&
                              S++)
                        : y < n && S++);
                    S < w;
                    ++S
                ...
                return (
                    b && d && M !== o
                        ? i.length && at(i[i.length - 1].value, o, Ia(o, v, t))
    ...
    const Va = (t) => Math.floor(r(t)),
        Ba = (t, e) => Math.pow(10, Va(t) + e);
    function Na(t) {
        return 1 == t / Math.pow(10, Va(t));
    }
    function Wa(t, e, i) {
    ...
    class Ha extends zs {
        ...
        parse(t, e) {
            t = za.prototype.parse.apply(this, [t, e]);
        ...
        handleTickRangeOptions() {
            ...
            var t = (t) => (s = e ? s : t),
                n = (t) => (a = i ? a : t);
            s === a && (s <= 0 ? (t(1), n(10)) : (t(Ba(s, -1)), n(Ba(a, 1)))),
                s <= 0 && t(Ba(a, -1)),
                a <= 0 && n(Ba(s, 1)),
                (this.min = s),
                (this.max = a);
                ...
                e = (function (t, { min: e, max: i }) {
                    ...
                    for (; u < i; )
                        s.push({ value: u, major: Na(u), significand: d }),
                            ...
                            (u =
                                Math.round((l + c + d * Math.pow(10, n)) * o) /
                                o);
                    return (
                        (e = g(t.max, u)),
    ...
    function $a(e) {
        ...
        for (let t = 0; t < o; t++) {
                ...
                c = Math.round(ct(u));
            {
                ...
                var f = i;
                var p = u;
                var m = Ya(c, h.x, d.w, 0, 180);
                var b = Ya(c, h.y, d.h, 90, 270);
                ...
                m.start < f.l
                    ? ((t = (f.l - m.start) / x),
                      (g.l = Math.min(g.l, f.l - t)))
                    : m.end > f.r &&
                      ((t = (m.end - f.r) / x), (g.r = Math.max(g.r, f.r + t))),
                    b.start < f.t
                        ? ((e = (f.t - b.start) / p),
                          (g.t = Math.min(g.t, f.t - e)))
                        : b.end > f.b &&
                          ((e = (b.end - f.b) / p),
        ...
        e.setCenterPoint(i.l - s.l, s.r - i.r, i.t - s.t, s.b - i.b),
            (e._pointLabelItems = (function (e, i, s) {
                const a = [],
                    ...
                    l = { extra: ja(t) / 2, additionalAngle: o ? S / n : 0 };
                let h;
                for (let t = 0; t < n; t++) {
    ...
    class Xa extends za {
        ...
        setDimensions() {
            var t = (this._padding = I(ja(this.options) / 2)),
        ...
        computeTickLimit() {
            return Math.ceil(this.drawingArea / ja(this.options));
        }
        generateTickLabels(t) {
    ...
    class tn extends zs {
        ...
        init(t, e = {}) {
            const i = t.time || (t.time = {}),
                s = (this._adapter = new la._date(t.adapters.date));
            s.init(e),
        ...
        parse(t, e) {
            return void 0 === t ? null : Ga(this, t);
        }
        beforeLayout() {
            super.beforeLayout(),
                (this._cache = { data: [], labels: [], all: [] });
            ...
            return (
                ...
                (this._majorUnit =
                    i.major.enabled && "year" !== this._unit
                        ? (function (i) {
                              for (
                                  let t = h.indexOf(i) + 1, e = h.length;
                                  t < e;
                                  ++t
                              )
                                  if (qa[h[t]].common) return h[t];
                          })(this._unit)
                        : void 0),
                this.initOffsets(s),
                t.reverse && n.reverse(),
        ...
        _generate() {
            const t = this._adapter,
                ...
                s = this.options,
                a = s.time,
                n = a.unit || Za(a.minUnit, e, i, this._getLabelCapacity(e)),
            ...
            for (c = u, d = 0; c < i; c = +t.add(c, o, n), d++) Ja(h, c, g);
            return (
                (c !== i && "ticks" !== s.bounds && 1 !== d) || Ja(h, c, g),
                Object.keys(h)
                    .sort((t, e) => t - e)
                    .map((t) => +t)
            );
    ...
    var sn = Object.freeze({
        ...
        CategoryScale: class extends zs {
            static id = "category";
            static defaults = { ticks: { callback: Ra } };
            constructor(t) {
                super(t),
                    (this._startValue = void 0),
                    (this._valueRange = 0),
        ...
        LinearScale: Fa,
        LogarithmicScale: Ha,
        RadialLinearScale: Xa,
        TimeScale: tn,
        TimeSeriesScale: class extends tn {
            static id = "timeseries";
            static defaults = tn.defaults;
            constructor(t) {
                super(t),
                    (this._table = []),
                    (this._minPos = void 0),
            ...
            initOffsets() {
                ...
                (this._minPos = en(e, this.min)),
                    (this._tableRange = en(e, this.max) - this._minPos),
                    super.initOffsets(t);
            }
            buildLookupTable(t) {
            ...
            getValueForPixel(t) {
                var e = this._offsets,
                    t = this.getDecimalForPixel(t) / e.factor - e.end;
                return en(this._table, t * this._tableRange + this._minPos, !0);
            }
        },
    });
    const an = [
        ...
        nn = an.map((t) => t.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
    function on(t) {
        return an[t % an.length];
    }
    function rn(t) {
        ...
        return (t, e) => {
            ...
            e instanceof fa
                ? (o =
                      ((s = t),
                      (a = o),
                      (s.backgroundColor = s.data.map(() => on(a++))),
                      a))
                : e instanceof pa
                ? (o =
                      ((s = t),
                      (i = o),
                      (s.backgroundColor = s.data.map(() => rn(i++))),
                      i))
                : e &&
                  (o =
                      ((e = t),
                        ...
                        if (
                            ...
                            var { start: n, count: o } = (function (t) {
                                ...
                                return (
                                    ...
                                    (i = l
                                        ? C(f(t, a.axis, o).hi + 1, s, e) - s
                                        : e - s),
                                    { start: s, count: i }
                                );
                            })(a);
                            if (o <= (M.threshold || 4 * l)) dn(e);
                            else {
                                let t;
                                switch (
                                    (P(i) &&
    ...
    function yn(t) {
        ...
        if ("stack" === a) {
            ...
            u.push(bn({ x: null, y: o.bottom }, l));
            for (let t = 0; t < c.length; t++) {
                const o = c[t];
                for (let t = o.start; t <= o.end; t++) vn(h, d[t], u);
            }
            return new Pa({ points: h, options: {} });
        }
        if ("shape" === a) return !0;
        s = (function (t) {
            var e = t.scale || {};
        ...
        return s instanceof _n ? s : bn(s, n);
    }
    function Mn(t, e, i) {
        var s,
            a = yn(e),
        ...
        a &&
            ...
            "x" === e &&
                i !== r &&
                (wn(s, l, n.top),
                kn(s, { line: a, target: l, color: r, scale: o, property: e }),
                s.restore(),
                s.save(),
                wn(s, l, n.bottom)),
            kn(s, { line: a, target: l, color: i, scale: o, property: e }),
            s.restore(),
            Be(t));
    }
    function wn(t, e, i) {
        ...
        const { line: s, target: a, property: n, color: o, scale: r } = i,
            l = (function (t, e, i) {
                ...
                for (const t of s) {
                    var { start: r, end: l } = t,
                        l = pn(r, l, a),
                        h = fn(i, a[r], a[l], t.loop);
                    if (e.segments) {
                        var c = Ei(e, h);
                        for (const e of c) {
                            const s = fn(i, n[e.start], n[e.end], e.loop),
                                d = Li(t, a, s);
                            for (const t of d)
                                o.push({
                                    source: t,
                                    target: e,
                                    start: { [i]: mn(h, s, "start", Math.max) },
                                    end: { [i]: mn(h, s, "end", Math.min) },
                                });
                        }
                    } else
                        o.push({
    ...
    class Cn extends e {
        ...
        fit() {
            ...
            if (i.display) {
                var a = i.labels,
                    ...
                    { boxWidth: a, itemHeight: l } = Dn(a, o);
                let t, e;
                (s.font = n.string),
                    this.isHorizontal()
                        ? ((t = this.maxWidth),
                          (e = this._fitRows(r, o, a, l) + 10))
                        : ((e = this.maxHeight),
        ...
        _draw() {
            ...
            this.drawTitle(),
                ...
                (u.lineWidth = 0.5),
                (u.font = b.string);
            const { boxWidth: M, boxHeight: w, itemHeight: k } = Dn(f, v),
                S = this.isHorizontal(),
                ...
                m.setWidth(this.width),
                    S
                        ? 0 < e &&
                          ...
                          y.line++,
                          (a = y.x =
                              E(g, this.left + x, this.right - d[y.line])))
                        : 0 < e &&
                          n + D > this.bottom &&
    ...
    var An = {
        ...
        _element: Cn,
        start(t, e, i) {
            var s = (t.legend = new Cn({ ctx: t.ctx, options: i, chart: t }));
    ...
    var Ln = {
        ...
        start(t, e, i) {
            ...
            (t = t),
                (i = i),
                (s = new Tn({ ctx: t.ctx, options: i, chart: t })),
                a.configure(t, s, i),
                a.addBox(t, s),
                (t.titleBlock = s);
        },
    ...
    var Rn = {
        id: "subtitle",
        start(t, e, i) {
            var s = new Tn({ ctx: t.ctx, options: i, chart: t });
            a.configure(t, s, i), a.addBox(t, s), En.set(t, s);
        },
        stop(t) {
            a.removeBox(t, En.get(t)), En.delete(t);
        },
        beforeUpdate(t, e, i) {
            const s = En.get(t);
            a.configure(t, s, i), (s.options = i);
    ...
    function w(t, e, i, s) {
        t = t[e].call(i, s);
        return void 0 === t ? jn[e].call(i, s) : t;
    }
    class Yn extends e {
        ...
        _resolveAnimations() {
            ...
            return (
                t._cacheable && (this._cachedAnimations = Object.freeze(e)), e
            );
        }
        getContext() {
            return (
        ...
        getTitle(t, e) {
            var e = e["callbacks"],
                ...
                t = x([], zn(i));
            return (t = x(t, zn(s))), x(t, zn(e));
        }
        getBeforeBody(t, e) {
            return Wn(w(e.callbacks, "beforeBody", this, t));
        }
        getBody(t, e) {
            const s = e["callbacks"],
                a = [];
            return (
                k(t, (t) => {
                    var e = { before: [], lines: [], after: [] },
                        i = Hn(s, t);
                    x(e.before, zn(w(i, "beforeLabel", this, t))),
                        x(e.lines, w(i, "label", this, t)),
                        x(e.after, zn(w(i, "afterLabel", this, t))),
                        a.push(e);
                }),
                a
            );
        ...
        getAfterBody(t, e) {
            return Wn(w(e.callbacks, "afterBody", this, t));
        }
        getFooter(t, e) {
            var e = e["callbacks"],
        ...
        _createItems(s) {
            ...
            return (
                ...
                k(
                    (l = s.itemSort
                        ? l.sort((t, e) => s.itemSort(t, e, a))
                        : l),
                    (t) => {
                        var e = Hn(s.callbacks, t);
        ...
        update(t, e) {
            ...
            let a,
                n = [];
            if (s.length) {
                const t = In[i.position].call(this, s, this._eventPosition),
                    e =
                        ...
                        (this._size = Fn(this, i))),
                    o = Object.assign({}, t, e),
                    r = Vn(this.chart, i, o),
                    l = Bn(i, o, r, this.chart);
    ...
    var $n = {
        ...
        positioners: In,
        afterInit(t, e, i) {
            i && (t.tooltip = new Yn({ chart: t, options: i }));
        },
        beforeUpdate(t, e, i) {
